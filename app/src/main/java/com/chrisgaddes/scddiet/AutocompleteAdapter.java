...
public class AutocompleteAdapter extends ArrayAdapter<Country> implements Filterable {
    ...
    private class DownloadCountry extends AsyncTask<String,Void,ArrayList<Country>>{
